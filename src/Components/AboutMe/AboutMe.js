        ...
        <div>
            <section className='aboutme'>
                ...
                <p className='aboutme-p'>
                    Passionné depuis tous petit par l'informatique et après plusieurs années en administration sans réel avancement dans ma carrière, j'ai décidé de me reconvertir dans le
                    développement Web.
                </p>
                <p className='aboutme-p'>
                    M'essayant a l'autodidacte pour commencer, j'ai ensuite cherché une formation qui correspondait a mes attentes et c'est comme ça que j'ai trouvé l'école 100% remote O'Clock.
                </p>
                <p className='aboutme-p'>
